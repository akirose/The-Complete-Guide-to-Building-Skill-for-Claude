...
Think of it like Home Depot. You might walk in with a problem - "Ineed to fix a
...
• Problem-first: "Ineed to set up a project workspace" → Your skill orchestrates
the right MCP calls in the right sequence. Users describe outcomes; the skill
handles the tools.
• Tool-first: "Ihave Notion MCP connected" → Your skill teaches Claude the
